...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create place" do
    assert_difference("Place.count") do
      post places_url, params: { place: { lat: @place.lat, lon: @place.lon, title: @place.title } }
    end
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { lat: @place.lat, lon: @place.lon, title: @place.title } }
